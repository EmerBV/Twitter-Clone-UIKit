...
class TweetTableViewCell: UITableViewCell {
    ...
    private let tweetTextContentLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "This is my Mockup tweet. Its going to take multiple lines. I believe some more text is enough but lets add some more anyway... And cheers Youtube!!!."
